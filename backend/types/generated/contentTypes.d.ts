...
export interface ApiAvisoAviso extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado_estudiante: Schema.Attribute.Enumeration<
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::aviso.aviso'> &
      Schema.Attribute.Private;
    personas_autorizada: Schema.Attribute.Relation<
      'oneToOne',
      'api::personas-autorizada.personas-autorizada'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiEstudianteEstudiante extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    personas_autorizadas: Schema.Attribute.Relation<
      'manyToMany',
      'api::personas-autorizada.personas-autorizada'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPersonasAutorizadaPersonasAutorizada
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nombre: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    telefono: Schema.Attribute.String & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    token: Schema.Attribute.Text & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::personas-autorizada.personas-autorizada': ApiPersonasAutorizadaPersonasAutorizada;
